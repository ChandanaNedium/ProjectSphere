...
import { ArrowLeft, GitCompare, CheckCircle, AlertTriangle, XCircle, Search, BarChart2, Lightbulb } from 'lucide-react'
...
function getSeverity(score: number) {
  if (score < 30) return { color: '#34d399', label: 'Low Similarity' }
  if (score < 50) return { color: '#fbbf24', label: 'Moderate Similarity' }
  if (score < 70) return { color: '#fb923c', label: 'High Similarity' }
  return { color: '#f87171', label: 'Very High Similarity' }
}
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'hsl(222, 47%, 6%)', color: 'hsl(210, 40%, 96%)', fontFamily: 'Inter, system-ui, sans-serif' }}>
      <div style={{
        ...
        <span style={{ fontSize: 14, fontWeight: 600 }}>Similarity Check</span>
      </div>
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '40px 24px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 12 }}>
          ...
          <h1 style={{ fontSize: 28, fontWeight: 800, letterSpacing: '-0.5px' }}>Similarity Check</h1>
        </div>
        ...
        {step === 'result' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            {/* Score */}
            <div style={{
              background: 'rgba(255,255,255,0.03)', border: `1.5px solid ${overall.color}33`,
              borderRadius: 16, padding: '28px', display: 'flex', alignItems: 'center', gap: 24,
            }}>
              <div style={{
                ...
                <div style={{
                  width: 76, height: 76, borderRadius: '50%', background: 'hsl(222, 47%, 8%)',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                }}>
                  ...
                  return (
                    <div key={p.id} style={{ display: 'flex', alignItems: 'center', gap: 16, padding: '14px', borderRadius: 10, background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.06)' }}>
                      ...
                      <Link href={`/project/${p.id}`} style={{
                        padding: '8px 14px', borderRadius: 8, background: 'rgba(59,130,246,0.1)',
