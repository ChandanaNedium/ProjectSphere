...
function SimilarityContent() {
  ...
  const [globalReport, setGlobalReport] =
    useState<GlobalSimilarityReport | null>(null);
  ...
  const PROGRESS_STEPS = [
    {
      id: "1",
      label: "Extracting structured representation & generating queries",
    },
    ...
    {
      id: "5",
      label: "Retrieving peer-reviewed academic literature via OpenAlex",
    },
    {
      id: "6",
      label:
        "Deduplicating candidates & computing multi-dimensional vector cosine similarities",
    },
    {
      id: "7",
      label: "Synthesizing research gap analysis & differentiation report",
    },
  ];
    ...
    try {
      if (mode === "global") {
        ...
        if (json.ok && json.data) {
          ...
          setErrorMessage(
            json.error || "Failed to complete global similarity analysis.",
          );
          setStep("input");
        }
      } else {
        ...
        if (json.ok && json.data) {
          ...
          setErrorMessage(
            json.error || "Failed to complete local similarity analysis.",
          );
          setStep("input");
        }
      }
  ...
  const handleDownloadReport = () => {
    ...
    setTimeout(() => {
      const top3 = globalReport.topMatches
        .slice(0, 5)
        .map((m, idx) => {
      ...
      const gaps = globalReport.researchGaps.potentialResearchGaps
        .map(
          (g, i) =>
            `\n${i + 1}. ${g.gap}\n   Context: ${g.context}\n   Focus: ${g.suggestedFocus}`,
        )
        .join("\n");

      const suggestions = globalReport.differentiationSuggestions
        .map((s, i) => `\n${i + 1}. ${s}`)
        .join("\n");
...
--------------------------------------------------------------------------------
${Object.entries(globalReport.sourceBreakdown)
  .map(
    ([src, stats]) =>
      `- ${src.padEnd(16)}: ${stats.count} matches, Highest: ${stats.highestScore}%, Avg: ${stats.averageScore}% ${stats.statusMessage ? `[${stats.statusMessage}]` : ""}`,
  )
  .join("\n")}
...
================================================================================`;
  ...
  const assessment = globalReport
    ? getAssessmentStyle(
        globalReport.overallAssessment,
        globalReport.highestMatchScore,
      )
    : localReport
          ...
          <div>
            ...
            >
              ...
              <div>
                ...
                >
                  Global Similarity & Novelty Checker
                </h1>
                <p style={{ color: "rgba(255,255,255,0.45)", fontSize: 13 }}>
                  Multi-source global project discovery & semantic vector
                  similarity analysis across ProjectSphere, GitHub, Web, and
                  Academic Research.
                </p>
              </div>
              ...
              <div>
                ...
                >
                  Provide a public GitHub repository so ProjectSphere can
                  analyze your implementation for similarity.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                gap: 6,
                background:
                  mode === "local" ? "rgba(59,130,246,0.2)" : "transparent",
          ...
          >
            ...
            >
              <div>
                ...
                >
                  <Sparkles
                    style={{ width: 16, height: 16, color: "#c084fc" }}
                  />
                ...
                >
                  Pre-fill with{" "}
                  <em>
                    &ldquo;AI-Based Smart Waste Segregation using Computer
                    Vision and IoT&rdquo;
                  </em>{" "}
                  to test multi-source discovery.
                </p>
              </div>
              <button
            ...
            >
              ...
              {mode === "global" && (
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Globe style={{ width: 15, height: 15 }} /> Public Web
                      Index
                    </div>
                    <div
                      style={{
                    ...
                    >
                      <BookOpen style={{ width: 15, height: 15 }} /> OpenAlex
                      Papers
                    </div>
                  </div>
                </div>
              ...
              >
                ...
                {mode === "global"
                  ? "Run Global Similarity & Novelty Discovery"
                  : "Run Local Database Similarity Check"}
              </button>
            </div>
          </div>
        )}
        ...
        {step === "analyzing" && (
          ...
          >
            ...
            <h2 style={{ fontSize: 22, fontWeight: 800, marginBottom: 8 }}>
              {mode === "global"
                ? "Performing Global Multi-Source Discovery…"
                : "Analyzing Local Similarity…"}
            </h2>
            <p
              style={{
                color: "rgba(255,255,255,0.45)",
            ...
            >
              Extracting structured representations, querying public external
              APIs, and calculating semantic vector cosine similarities across 5
              dimensions.
            </p>
        ...
        {step === "result" && (
          ...
          >
              ...
              <div style={{ display: "flex", gap: 10 }}>
                {globalReport && (
                  ...
                  >
                    ...
                    {downloading ? "Preparing…" : "Export Report (TXT)"}
                  </button>
                )}
                <button
            ...
            <div
              style={{
                background: "rgba(255,255,255,0.03)",
                border: `1.5px solid ${assessment.border}`,
                borderRadius: 20,
                padding: "32px",
                display: "flex",
                alignItems: "center",
                  ...
                  >
                    <span>
                      ...
                      <strong style={{ color: "white" }}>
                        {globalReport.averageSimilarity}%
                      </strong>
                    </span>
                    <span>
                      Total Candidates:{" "}
                      <strong style={{ color: "white" }}>
                        {globalReport.sourcesAnalyzed.total}
                      </strong>
                    </span>
                    <span>
                      Embedding Engine:{" "}
                      <strong style={{ color: "#c084fc" }}>
                        {globalReport.embeddingEngine.split("(")[0]}
                      </strong>
                    </span>
                  </div>
                )}
            ...
            {(globalReport?.repositoryAnalysis ||
              localReport?.repositoryAnalysis) && (
              <div
                style={{
                  background: "rgba(59,130,246,0.06)",
                  border: "1px solid rgba(59,130,246,0.2)",
              ...
              >
                ...
                {(() => {
                  ...
                  return profile ? (
                    ...
                    >
                      <div>
                        <strong>Repository:</strong> {profile.owner}/
                        {profile.repositoryName}
                      </div>
                      <div>
                        <strong>Languages:</strong>{" "}
                        {profile.languages.join(", ") || "Not detected"}
                      </div>
                      <div>
                        <strong>Frameworks:</strong>{" "}
                        {profile.frameworks.join(", ") || "Not detected"}
                      </div>
                      <div>
                        <strong>Architecture:</strong>{" "}
                        {profile.architecture.join(", ") || "Not detected"}
                      </div>
                      <div>
                        <strong>Key modules:</strong>{" "}
                        {profile.keyModules.slice(0, 8).join(", ") ||
                          "Not detected"}
                      </div>
                      <div>
                      ...
                      <a
                        ...
                        style={{ color: "#93c5fd", marginTop: 4 }}
                      >
            ...
            {globalReport && (
              <div>
                ...
                >
                  <Layers style={{ width: 18, height: 18, color: "#c084fc" }} />{" "}
                  Multi-Source Discovery Breakdown
                </h3>
                  ...
                  {(
                    ...
                    return (
                      <div
                        key={source}
                        onClick={() =>
                          setActiveSourceFilter(isSelected ? "all" : source)
                        }
                        style={{
                          borderRadius: 14,
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <badge.icon style={{ width: 14, height: 14 }} />{" "}
                            {source}
                          </span>
                          <span
                            style={{
                        ...
                        >
                          {stats?.statusMessage ||
                            (count > 0
                              ? `Avg: ${stats.averageScore}% similarity`
                              : "No close matches")}
                        </div>
                      </div>
                    );
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    {globalReport.queriesExecuted.length})
                  </span>
                  {showQueries ? (
                    ...
                    {globalReport.queriesExecuted.map((q, idx) => (
                      ...
                      >
                        ...
                        >
                          <span>
                            Perspective:{" "}
                            <b>{q.perspective.replace(/_/g, " ")}</b>
                          </span>
                          <span>
                            Target Sources: <b>{q.targetSources.join(", ")}</b>
                          </span>
                        </div>
                      </div>
                    ))}
            ...
            <div>
              ...
              >
                <h3 style={{ fontWeight: 800, fontSize: 18 }}>
                  Top Matching Discoveries (
                  {filteredMatches.length > 0
                    ? filteredMatches.length
                    : localReport?.similar?.length || 0}
                  )
                </h3>
                {globalReport && (
              ...
              >
                {globalReport &&
                  filteredMatches.map((match: ExternalProjectResult) => {
                    const badge = getSourceBadge(match.source);
                    const matchStyle = getAssessmentStyle(
                      undefined,
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          <div style={{ flex: 1, minWidth: 280 }}>
                            ...
                            >
                              ...
                              >
                                <badge.icon style={{ width: 12, height: 12 }} />{" "}
                                {match.source}
                              </span>
                        ...
                        >
                          <DimensionBar
                            label="Problem (35%)"
                            value={match.dimensionScores.problemScore}
                            color="#60a5fa"
                          />
                          <DimensionBar
                            label="Method (25%)"
                            value={match.dimensionScores.methodologyScore}
                            color="#c084fc"
                          />
                          <DimensionBar
                            label="Tech (20%)"
                            value={match.dimensionScores.technologyScore}
                            color="#34d399"
                          />
                          <DimensionBar
                            label="Domain (10%)"
                            value={match.dimensionScores.domainScore}
                            color="#fbbf24"
                          />
                          <DimensionBar
                            label="Outcome (10%)"
                            value={match.dimensionScores.outcomeScore}
                            color="#f472b6"
                          />
                        </div>
            ...
            {globalReport && (
              ...
              >
                ...
                >
                  ...
                  <div>
                    <h3 style={{ fontWeight: 800, fontSize: 17, margin: 0 }}>
                      Research Gap Analysis from Analyzed Literature
                    </h3>
                    <p
                      style={{
                        fontSize: 12,
                    ...
                    >
                      Synthesized from retrieved academic papers, GitHub
                      projects, and web search results.
                    </p>
                  </div>
                </div>
                ...
                >
                  {globalReport.researchGaps.potentialResearchGaps.map(
                    (gap, i) => (
                      <div
                        key={i}
                        style={{
            ...
            {globalReport && (
              ...
              >
                ...
                >
                  <Sparkles
                    style={{ width: 22, height: 22, color: "#c084fc" }}
                  />
                  <h3 style={{ fontWeight: 800, fontSize: 17, margin: 0 }}>
                    Practical Differentiation Strategies for Your Project
                  </h3>
                </div>
