...
export default function UploadPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (
      ...
      setFormError(
        "Enter a public GitHub repository URL such as https://github.com/username/project.",
      );
      return;
    }
    setFormError("");
      ...
      >
        {step === "success" ? (
          ...
          >
            <div style={{ textAlign: "center", maxWidth: 520 }}>
              ...
              >
                ...
                has been saved and is now visible in the Explore page. It&apos;s
                marked as &ldquo;Under Review&rdquo; until our team verifies
                originality.
              </p>
              <div
                style={{
          ...
          <>
            ...
            >
              Share your project with 10,000+ students across India. We&apos;ll
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <select
                    ...
                    style={{ ...inputStyle, cursor: "pointer" }}
                  >
                    {["Research", "Product", "Tool", "Dataset"].map((t) => (
                      <option
                        key={t}
                        value={t}
                        style={{ background: "#0d1117" }}
              ...
              <div>
                ...
                >
                  ...
                  analyze your implementation for similarity. ProjectSphere
                  analyzes publicly accessible repository information to
                  generate an implementation profile.
                </p>
                {formError && (
                  <p
                    style={{
              ...
              >
                📋 After submission, our AI will run a{" "}
                <strong style={{ color: "white" }}>similarity analysis</strong>{" "}
                comparing your project against 1,200+ existing projects.
                You&apos;ll receive a detailed originality report within 24
                hours.
              </div>
