...
export interface ProjectInput {
  ...
  repositoryProfile?: import("@/lib/github-repository-analyzer").RepositoryImplementationProfile;
}
...
export interface GlobalSimilarityReport {
  ...
  repositoryAnalysis?:
    | import("@/lib/github-repository-analyzer").RepositoryImplementationProfile
    | null;
  repositoryAnalysisError?: string;
}
